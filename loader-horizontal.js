 ...
 * 水平，一个球在几个球之间来回徘徊
 */
function HorizontalLoader(canvas) {
  this._canvas = canvas;
 ...
 * 初始化
 */
HorizontalLoader.prototype.init = function (option) {
 ...
 * 开始
 */
HorizontalLoader.prototype.start = function () {
  this._invalidate();
  this._validate(this);
}
 ...
 * 停止
 */
HorizontalLoader.prototype.stop = function () {
  this._invalidate();
}
 ...
 * 设置画笔
 */
HorizontalLoader.prototype._setPaint = function (fillColor) {
 ...
 * 界面刷新的时候会进行回调
 */
HorizontalLoader.prototype._onDraw = function () {
  /** 获取动态圆此刻计算的x坐标 */
 ...
 * 绘制圆形
 */
HorizontalLoader.prototype._drawCircle = function (x, y, r) {
 ...
 * 判断是否允许绘制粘连体
 */
HorizontalLoader.prototype._adherentBodyEnable = function (staticCircle) {
 ...
 * 先加速后减速的正弦缓动函数
 */
HorizontalLoader.prototype._easeInOutSine = function (time, startValue, endValue, duration) {
 ...
 * 利用贝塞尔曲线绘制粘连体
 */
HorizontalLoader.prototype._drawAdherentBody = function (cx1, cy1, cr1, offset1, cx2, cy2, cr2, offset2) {
  /** 求三角函数 */
 ...
 * 绘制
 */
HorizontalLoader.prototype._validate = function (self) {
  this._frame = 0;
 ...
 * 不绘制
 */
HorizontalLoader.prototype._invalidate = function () {
 ...
 * 擦除画布
 */
HorizontalLoader.prototype._clean = function () {
